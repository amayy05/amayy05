...
# ===========================================================================
HOST = "amay"   # shown as  amay@github  in the header

ROWS = [
    ("host",),
    ("kv", "Now", "Co-founder @ Nexacrft (web + creative agency)"),
    ("kv", "Prev", "AR/VR Intern @ IOFT (Unity Engine)"),
    ("kv", "Prev", "Backend Intern @ KantasCrypt (APIs)"),
    ("kv", "Prev", "Web Dev Intern @ Sarsarjan Group"),
    ("kv", "Edu", "B.Tech CSE, SJCEM Palghar '26"),
    ("gap",),
    ("sec", "Stack"),
    ("kv", "Frontend", "React, Three.js, HTML/CSS/JS"),
    ("kv", "Backend", "Node.js, REST APIs, Python"),
    ("kv", "AR/VR", "Unity Engine, C#"),
    ("kv", "Other", "Git, Figma, Canva"),
    ("gap",),
    ("sec", "Highlights"),
    ("bul", "Built a scroll-driven 3D portfolio in Three.js"),
    ("bul", "Running Nexacrft, a web + creative agency"),
]
